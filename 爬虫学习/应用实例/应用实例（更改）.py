...
def getComment(html):
    ...
    div = soup.find_all(attrs={'class':'comment-list new_score show'})
...
exclude={"的","是","这","了","和","也","都","他","有","阿朱","处有"}
...
def createWordCloud(fileName):
    with open(fileName,'r',encoding='utf-8') as file:
        ...
        wcloud = WordCloud(font_path = "/System/Library/fonts/PingFang.ttc",
...
#评论列表全部写入文件
fileName = '/Users/oohao/Library/Mobile Documents/com~apple~CloudDocs/py_work/爬虫学习/应用实例/天龙八部评论.txt'
